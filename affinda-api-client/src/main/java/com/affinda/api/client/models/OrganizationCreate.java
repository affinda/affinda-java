...
/** The OrganizationCreate model. */
@Fluent
public final class OrganizationCreate {
    /*
     * The name property.
     */
     ...
     * @return the OrganizationCreate object itself.
     */
    public OrganizationCreate setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the OrganizationCreate object itself.
     */
    public OrganizationCreate setAvatar(Flux<ByteBuffer> avatar) {
        this.avatar = avatar;
        return this;
    }
     ...
     * @return the OrganizationCreate object itself.
     */
    public OrganizationCreate setResthookSignatureKey(String resthookSignatureKey) {
