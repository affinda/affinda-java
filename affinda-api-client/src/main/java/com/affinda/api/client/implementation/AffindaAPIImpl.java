...
public final class AffindaAPIImpl implements AffindaAPI {
     ...
     */
    AffindaAPIImpl(int limit, int offset, String host) {
        this(
     ...
     * @param host server parameter.
     */
    AffindaAPIImpl(HttpPipeline httpPipeline, int limit, int offset, String host) {
     ...
     * @param host server parameter.
     */
    AffindaAPIImpl(HttpPipeline httpPipeline, SerializerAdapter serializerAdapter, int limit, int offset, String host) {
