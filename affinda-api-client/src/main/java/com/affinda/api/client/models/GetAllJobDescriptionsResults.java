...
/** The GetAllJobDescriptionsResults model. */
@Fluent
public final class GetAllJobDescriptionsResults {
    /*
     ...
     * @return the GetAllJobDescriptionsResults object itself.
     */
    public GetAllJobDescriptionsResults setCount(Integer count) {
        this.count = count;
        return this;
    }
     ...
     * @return the GetAllJobDescriptionsResults object itself.
     */
    public GetAllJobDescriptionsResults setNext(String next) {
        this.next = next;
        return this;
    }
     ...
     * @return the GetAllJobDescriptionsResults object itself.
     */
    public GetAllJobDescriptionsResults setPrevious(String previous) {
     ...
     * @return the GetAllJobDescriptionsResults object itself.
     */
    public GetAllJobDescriptionsResults setResults(List<Meta> results) {
