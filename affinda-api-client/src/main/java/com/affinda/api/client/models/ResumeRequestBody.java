...
public final class ResumeRequestBody {
     ...
     * @return the ResumeRequestBody object itself.
     */
    public ResumeRequestBody setCustomIdentifier(String customIdentifier) {
     ...
     * @return the ResumeRequestBody object itself.
     */
    public ResumeRequestBody setRegionBias(String regionBias) {
     ...
     * @return the ResumeRequestBody object itself.
     */
    public ResumeRequestBody setLowPriority(Boolean lowPriority) {
