...
/** The Paths18Iqsr4V2IndexGetResponses200ContentApplicationJsonSchema model. */
@Fluent
public final class Paths18Iqsr4V2IndexGetResponses200ContentApplicationJsonSchema {
    /*
     ...
     * @return the Paths18Iqsr4V2IndexGetResponses200ContentApplicationJsonSchema object itself.
     */
    public Paths18Iqsr4V2IndexGetResponses200ContentApplicationJsonSchema setCount(Integer count) {
        this.count = count;
        return this;
    }
     ...
     * @return the Paths18Iqsr4V2IndexGetResponses200ContentApplicationJsonSchema object itself.
     */
    public Paths18Iqsr4V2IndexGetResponses200ContentApplicationJsonSchema setNext(String next) {
        this.next = next;
        return this;
    }
     ...
     * @return the Paths18Iqsr4V2IndexGetResponses200ContentApplicationJsonSchema object itself.
     */
    public Paths18Iqsr4V2IndexGetResponses200ContentApplicationJsonSchema setPrevious(String previous) {
     ...
     * @return the Paths18Iqsr4V2IndexGetResponses200ContentApplicationJsonSchema object itself.
     */
    public Paths18Iqsr4V2IndexGetResponses200ContentApplicationJsonSchema setResults(
