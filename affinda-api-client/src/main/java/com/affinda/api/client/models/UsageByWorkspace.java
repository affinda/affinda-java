...
@Fluent
public final class UsageByWorkspace {
    /*
     * Month of the usage
     */
     ...
     * @return the UsageByWorkspace object itself.
     */
    public UsageByWorkspace setMonth(String month) {
        this.month = month;
        return this;
    }
     ...
     * @return the UsageByWorkspace object itself.
     */
    public UsageByWorkspace setCount(int count) {
        this.count = count;
        return this;
    }
}
