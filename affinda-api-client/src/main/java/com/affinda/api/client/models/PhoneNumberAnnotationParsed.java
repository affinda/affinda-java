...
/** The PhoneNumberAnnotationParsed model. */
@Fluent
public final class PhoneNumberAnnotationParsed {
    /*
     ...
     * @return the PhoneNumberAnnotationParsed object itself.
     */
    public PhoneNumberAnnotationParsed setRawText(String rawText) {
     ...
     * @return the PhoneNumberAnnotationParsed object itself.
     */
    public PhoneNumberAnnotationParsed setFormattedNumber(String formattedNumber) {
     ...
     * @return the PhoneNumberAnnotationParsed object itself.
     */
    public PhoneNumberAnnotationParsed setCountryCode(String countryCode) {
     ...
     * @return the PhoneNumberAnnotationParsed object itself.
     */
    public PhoneNumberAnnotationParsed setInternationalCountryCode(Integer internationalCountryCode) {
     ...
     * @return the PhoneNumberAnnotationParsed object itself.
     */
    public PhoneNumberAnnotationParsed setNationalNumber(String nationalNumber) {
