...
/** The ExtractorBaseExtractor model. */
@Fluent
public final class ExtractorBaseExtractor {
    /*
     * The id property.
     */
     ...
     * @return the ExtractorBaseExtractor object itself.
     */
    public ExtractorBaseExtractor setId(int id) {
        this.id = id;
        return this;
    }
     ...
     * @return the ExtractorBaseExtractor object itself.
     */
    public ExtractorBaseExtractor setIdentifier(String identifier) {
     ...
     * @return the ExtractorBaseExtractor object itself.
     */
    public ExtractorBaseExtractor setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the ExtractorBaseExtractor object itself.
     */
    public ExtractorBaseExtractor setNamePlural(String namePlural) {
     ...
     * @return the ExtractorBaseExtractor object itself.
     */
    public ExtractorBaseExtractor setValidatable(boolean validatable) {
     ...
     * @return the ExtractorBaseExtractor object itself.
     */
    public ExtractorBaseExtractor setIsCustom(Boolean isCustom) {
     ...
     * @return the ExtractorBaseExtractor object itself.
     */
    public ExtractorBaseExtractor setCreatedDt(OffsetDateTime createdDt) {
