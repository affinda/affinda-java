...
public final class InvoiceDataBankSortCode extends TextAnnotationV2 {
     ...
     * @return the InvoiceDataBankSortCode object itself.
     */
    public InvoiceDataBankSortCode setRaw(String raw) {
        this.raw = raw;
        return this;
    }
     ...
     * @return the InvoiceDataBankSortCode object itself.
     */
    public InvoiceDataBankSortCode setParsed(String parsed) {
        this.parsed = parsed;
        return this;
    }
}
