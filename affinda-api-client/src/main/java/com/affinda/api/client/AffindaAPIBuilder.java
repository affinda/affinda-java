...
public final class AffindaAPIBuilder
        implements HttpTrait<AffindaAPIBuilder>,
                ConfigurationTrait<AffindaAPIBuilder>,
                TokenCredentialTrait<AffindaAPIBuilder> {
    @Generated private static final String SDK_NAME = "name";

    @Generated private static final String SDK_VERSION = "version";

    @Generated private static final String[] DEFAULT_SCOPES = new String[] {"https://management.azure.com/.default"};
    ...
    @Generated
    @Override
    public AffindaAPIBuilder retryOptions(RetryOptions retryOptions) {
