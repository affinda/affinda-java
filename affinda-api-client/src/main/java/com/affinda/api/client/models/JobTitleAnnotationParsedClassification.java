...
public final class JobTitleAnnotationParsedClassification {
     ...
     * @return the JobTitleAnnotationParsedClassification object itself.
     */
    public JobTitleAnnotationParsedClassification setMinorGroupCode(Integer minorGroupCode) {
     ...
     * @return the JobTitleAnnotationParsedClassification object itself.
     */
    public JobTitleAnnotationParsedClassification setSubMajorGroupCode(Integer subMajorGroupCode) {
     ...
     * @return the JobTitleAnnotationParsedClassification object itself.
     */
    public JobTitleAnnotationParsedClassification setMajorGroupCode(Integer majorGroupCode) {
